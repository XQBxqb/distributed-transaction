...
@FeignClient(name = ServiceoBookApi.SERVERNAME)
public interface ServiceoBookApi {
    static final String SERVERNAME = "serviceo";

    static final String PREFIX = "/api/serviceo/book";
